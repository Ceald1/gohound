...
var ACETYPE = []string{ // whitelisted ace types
	"A",
	"OA",
	"AU",
	"AL",
...
var FLAGS = map[string]string{
	...
	"WD": "WriteDacl",
	"WO": "WriteOwner",
	"WP": "GenericWrite",      // Write All Properties
	"CR": "AllExtendedRights", // All Extended Rights
	"SW": "ValidatedWrites",   // Validated Writes
}
...
var Attributes = []string{
	...
	"mustHaveObjectClass",
	"mayHaveObjectClass",
	"systemMayHaveObjectClass",
	"systemMustHaveObjectClass",
}

var WellKnownSIDs = map[string]string{
	// BUILTIN SIDs (S-1-5-32-*)
	...
	"S-1-5-5-X-Y": "NT AUTHORITY\\LOGON_ID", // Special case
	"S-1-5-6":     "NT AUTHORITY\\SERVICE",
	"S-1-5-7":     "NT AUTHORITY\\ANONYMOUS",
	"S-1-5-8":     "NT AUTHORITY\\PROXY",
	"S-1-5-9":     "NT AUTHORITY\\ENTERPRISE_DOMAIN_CONTROLLERS",
	"S-1-5-10":    "NT AUTHORITY\\PRINCIPAL_SELF",
	"S-1-5-11":    "NT AUTHORITY\\Authenticated Users",
	"S-1-5-12":    "NT AUTHORITY\\RESTRICTED",
	"S-1-5-13":    "NT AUTHORITY\\TERMINAL_SERVER_USER",
	"S-1-5-14":    "NT AUTHORITY\\REMOTE_INTERACTIVE_LOGON",
	"S-1-5-15":    "NT AUTHORITY\\THIS_ORGANIZATION",
...
var ExtendedRightsToBH = map[string]string{
	// ── Password Control ─────────────────────────────────────────────────────
	"User-Change-Password":       "ForceChangePassword",
	...
	"DS-Replication-Synchronize":                   "DCSync",
	"DS-Replication-Manage-Topology":               "DCSync",
	"DS-Replication-Monitor-Topology":              "DCSync",
	"Read-Only-Replication-Secret-Synchronization": "DCSync",
	...
	"Validated-DNS-Host-Name":                  "WriteSPN",
	"Validated-MS-DS-Additional-DNS-Host-Name": "WriteSPN",
	"Validated-MS-DS-Behavior-Version":         "WriteAccountRestrictions",
	"DS-Validated-Write-Computer":              "AddKeyCredentialLink",

	// ── Certificate / ADCS ───────────────────────────────────────────────────
	"Certificate-Enrollment":     "ADCSESC1",
	"Certificate-AutoEnrollment": "ADCSESC1",

	// ── Ownership ────────────────────────────────────────────────────────────
	"DS-Set-Owner": "Owns",

	// ── SID History ──────────────────────────────────────────────────────────
	"Migrate-SID-History": "SpoofSIDHistory",

	// ── Group Policy ─────────────────────────────────────────────────────────
	"Apply-Group-Policy": "GPLink",

	// ── Trust / Replication Topology ─────────────────────────────────────────
	"Create-Inbound-Forest-Trust": "CrossForestTrust",
	"DS-Install-Replica":          "CrossForestTrust",

	// ── DC Operations ────────────────────────────────────────────────────────
	"DS-Clone-Domain-Controller": "DCFor",

	// ── Delegation / Authentication ───────────────────────────────────────────
	"Allowed-To-Authenticate": "AllowedToDelegate",

	// ── Sensitive Data Read ───────────────────────────────────────────────────
	"DS-Read-Partition-Secrets": "DCSync",
	"Private-Information":       "ReadLAPSPassword",

	// ── Write Partition Secrets ───────────────────────────────────────────────
	"DS-Write-Partition-Secrets": "WriteDacl",
}
...
var SCHEMA_OBJECTS = map[string]string{
